<script>
  ...
  import hero from '../assets/apple-touch-icon.png'; // Example image for LLM hero section
  // import '../index.scss';
...
<header class="bg-gradient-to-r from-[#00b4d8] to-[#0f4c75] text-white py-4 px-6 flex flex-col md:flex-row items-center justify-between shadow-lg fixed top-0 w-full z-50">
  ...
  <div class="flex space-x-4 mt-4 md:mt-0">
    ...
    <button class="bg-transparent border border-blue-200 text-white px-4 py-2 rounded-full shadow-md hover:bg-blue-300 hover:text-[#023e8a] transition-all duration-300 transform hover:scale-105">Partner with Us 🤝</button>
  </div>
</header>
...
<section id="features" class="section-padding bg-gradient-to-r from-[#f0f4f8] to-white py-16">
  <div class="container mx-auto text-center">
    <h2 class="text-4xl font-bold text-[#023e8a] mb-8">Platform Features</h2>
...
<section id="integrations" class="section-padding bg-gradient-to-r from-blue-50 to-white py-16">
  <div class="container mx-auto text-center">
    <h2 class="text-4xl font-bold text-[#023e8a] mb-8">Seamless Integrations</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {#each items as {imgSrc, title, description} }
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
          ...
          <h3 class="text-xl font-semibold text-[#023e8a] mb-2">{title}</h3>
